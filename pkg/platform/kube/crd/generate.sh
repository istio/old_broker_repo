...
// Sources: model/config.go
// Output: platform/kube/crd/types.go
...
CRDS="MockConfig ServiceClass ServicePlan"
...
for crd in $CRDS; do
  sed -e "1,22d;s/IstioKind/$crd/g" platform/kube/crd/template.go
done
